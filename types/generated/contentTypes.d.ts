...
export interface ApiBannerBanner extends Schema.CollectionType {
  ...
  attributes: {
    ...
    imgbanner: Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiCarrelloCarrello extends Schema.CollectionType {
  ...
  attributes: {
    cliente: Attribute.Relation<
      ...
      'api::cliente.cliente'
    >;
    item_carrelli: Attribute.Relation<
      'api::carrello.carrello',
      'oneToMany',
      'api::item-carrello.item-carrello'
    >;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
...
export interface ApiCartaCarta extends Schema.CollectionType {
  ...
  attributes: {
    nome: Attribute.String;
    Circuito: Attribute.Enumeration<
      ['MasterCard', 'Visa', 'American Express', 'Bancomat']
    >;
...
export interface ApiCheckoutCheckout extends Schema.CollectionType {
  ...
  attributes: {
    ...
    modalitaPag: Attribute.Enumeration<['Carta', 'Paypal', 'Constrassegno']>;
    citta: Attribute.String;
    nominativo: Attribute.String;
    telefono: Attribute.BigInteger;
    codicep: Attribute.BigInteger;
    provincia: Attribute.String;
    aquistodata: Attribute.Date;
    carta: Attribute.Relation<
...
export interface ApiClienteCliente extends Schema.CollectionType {
  ...
  attributes: {
    ...
    indirizzo: Attribute.String;
    telefono: Attribute.BigInteger;
    imgprofile: Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
    cartes: Attribute.Relation<
      'api::cliente.cliente',
      'oneToMany',
      'api::carta.carta'
    >;
    account: Attribute.Relation<
      ...
      'api::account.account'
    >;
    carrello: Attribute.Relation<
      'api::cliente.cliente',
      'oneToOne',
      'api::carrello.carrello'
    >;
    preferiti: Attribute.Relation<
      'api::cliente.cliente',
      'oneToMany',
      'api::preferito.preferito'
    >;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
...
export interface ApiItemCarrelloItemCarrello extends Schema.CollectionType {
...
export interface ApiPreferitoPreferito extends Schema.CollectionType {
...
export interface ApiProdottoProdotto extends Schema.CollectionType {
  ...
  attributes: {
    categoria: Attribute.Enumeration<
      ['Pantalone', 'T-shirt', 'Felpa', 'Camicia', 'Accessorio']
    > &
      Attribute.Required;
    ...
    tipo: Attribute.Enumeration<['Uomo', 'Donna', 'Accessorio']> &
      Attribute.Required;
    Taglia: Attribute.Enumeration<['XS', 'S', 'M', 'L', 'XL']>;
    Colore: Attribute.Enumeration<
      ['Verde', 'Blu', 'Rosso', 'Nero', 'Bianco', 'Marrone', 'Viola', 'Grigio']
    > &
      Attribute.Required;
    sconto: Attribute.Relation<
      'api::prodotto.prodotto',
      'manyToOne',
      'api::sconto.sconto'
    >;
    marca: Attribute.String & Attribute.Required;
    pngProd: Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
    quantita: Attribute.Integer & Attribute.Required;
    preferito: Attribute.Relation<
      'api::prodotto.prodotto',
      'manyToMany',
      'api::preferito.preferito'
    >;
...
export interface ApiScontoSconto extends Schema.CollectionType {
  ...
  attributes: {
    ...
    inizio: Attribute.Date;
    fine: Attribute.Date;
    attiva: Attribute.Boolean;
    prodottos: Attribute.Relation<
      'api::sconto.sconto',
      'oneToMany',
      'api::prodotto.prodotto'
    >;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::carrello.carrello': ApiCarrelloCarrello;
      'api::carta.carta': ApiCartaCarta;
      'api::checkout.checkout': ApiCheckoutCheckout;
      'api::cliente.cliente': ApiClienteCliente;
      'api::faq.faq': ApiFaqFaq;
      'api::item-carrello.item-carrello': ApiItemCarrelloItemCarrello;
      'api::preferito.preferito': ApiPreferitoPreferito;
      'api::prodotto.prodotto': ApiProdottoProdotto;
      'api::sconto.sconto': ApiScontoSconto;
    }
  }
}
